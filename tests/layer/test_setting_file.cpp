...
TEST(test_layer_setting_file, vlGetLayerSettingValues_Bool) {
    ...
    test_helper_SetLayerSetting(layer_setting_set, "lunarg_test.my_setting", "true,false");
...
TEST(test_layer_setting_file, vlGetLayerSettingValues_Int32) {
    ...
    test_helper_SetLayerSetting(layer_setting_set, "lunarg_test.my_setting", "76,-82");
...
TEST(test_layer_setting_file, vlGetLayerSettingValues_Float) {
    ...
    test_helper_SetLayerSetting(layer_setting_set, "lunarg_test.my_setting", "76.1f,-82.5f");
...
TEST(test_layer_setting_file, vlGetLayerSettingValues_Double) {
    ...
    test_helper_SetLayerSetting(layer_setting_set, "lunarg_test.my_setting", "76.1,-82.5");
...
TEST(test_layer_setting_file, vlGetLayerSettingValues_Frameset) {
    ...
    test_helper_SetLayerSetting(layer_setting_set, "lunarg_test.my_setting", "76-100-10,1-100-1");
...
TEST(test_layer_setting_file, vlGetLayerSettingValues_String) {
    ...
    test_helper_SetLayerSetting(layer_setting_set, "lunarg_test.my_setting", "VALUE_A,VALUE_B");
